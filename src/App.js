      ...
      <main>
        <Routes>
          ...
          <Route
            ...
            element={<Activity user={user} authenticated={authenticated} />}
          />
          ...
          />
          <Route path="/search-results/:activity" element={<SearchResults />} />
          <Route path="/add-activity" element={<AddActivity user={user} />} />
          <Route
